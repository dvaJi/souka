...
const _MT_STRING_CHECKBOX_IGNOREIMGFILENAME = "Ignore filename in Souka Text";
...
const _MT_ERROR_NOTFOUNLABELTEXT = "Souka Text File Not Found!";
const _MT_ERROR_CANNOTBUILDNEWFOLDER = "Could not build new folder";
const _MT_ERROR_READLABELTEXTFILEFAILL = "Fail To Load Souka Text File";
